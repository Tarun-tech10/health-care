    ...
    if (loginForm) {
        ...
        loginForm.addEventListener('submit', async function(e) {
            ...
            try {
                ...
                console.log('Sending login request to:', 'https://health-care-production-54d7.up.railway.app/api/login');
                console.log('Request body:', requestBody);
                
                const response = await fetch('https://health-care-production-54d7.up.railway.app/api/login', {
                    method: 'POST',
                    headers: {
    ...
    if (registrationForm) {
        ...
        registrationForm.addEventListener('submit', async function(e) {
            ...
            try {
                ...
                console.log('Sending registration request to:', 'https://health-care-production-54d7.up.railway.app/api/register');
                console.log('Request body:', requestBody);

                const response = await fetch('https://health-care-production-54d7.up.railway.app/api/register', {
                    method: 'POST',
                    headers: {
                        'Content-Type': 'application/json'
                    },
